...
public class TextParticle extends Entity {
	...
	public TextParticle(String msg, int x, int y, int col, int timeAlive) {
		this.msg = msg;
		this.x = x;
		this.y = y;
		this.col = col;
		...
		yy = y;
		zz = 2;
		xa = 0;//random.nextGaussian() * 0.3;
		ya = (random.nextGaussian() * 0.5) +-(random.nextGaussian() * 0.5);//0.5;
		za = 0;//random.nextFloat() * 0.7 + 2;
	}
