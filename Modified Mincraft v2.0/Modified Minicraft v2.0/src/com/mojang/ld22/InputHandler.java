...
public class InputHandler implements KeyListener {
	...
	public Key unequip = new Key();
	public Key interact = new Key();
	public Key favor = new Key();
	...
	private void toggle(KeyEvent ke, boolean pressed) {
		...
		if (ke.getKeyCode() == KeyEvent.VK_V) unequip.toggle(pressed);
		if (ke.getKeyCode() == KeyEvent.VK_I) interact.toggle(pressed);
		if (ke.getKeyCode() == KeyEvent.VK_F) favor.toggle(pressed);
