...
public class InstructionsMenu extends Menu {
	...
	public void render(Screen screen) {
		...
		Font.draw("equip it, and", screen, 0 * 8 + 4, 11 * 8, Color.get(0, 333, 333, 333));
		Font.draw("press V to unequip,", screen, 0 * 8 + 4, 12 * 8, Color.get(0, 333, 333, 333));
		Font.draw("press I to interact,", screen, 0 * 8 + 4, 13 * 8, Color.get(0, 333, 333, 333));
		Font.draw("press F to save items", screen, 0 * 8 + 4, 14 * 8, Color.get(0, 333, 333, 333));
		Font.draw("as favorites.", screen, 0 * 8 + 4, 15 * 8, Color.get(0, 333, 333, 333));
		Font.draw("Kill the air wizard", screen, 0 * 8 + 4, 16 * 8, Color.get(0, 333, 333, 333));
		Font.draw("to win the game!", screen, 0 * 8 + 4, 17 * 8, Color.get(0, 333, 333, 333));
	}
}
