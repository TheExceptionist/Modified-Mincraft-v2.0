...
public class Resource {
	...
	//Change the heal values to the bread and apple
	//Change stamina cost for eating to 0
	public static Resource bread = new FoodResource("Bread", 8 + 4 * 32, Color.get(-1, 110, 330, 550), 10, 0);
	public static Resource apple = new FoodResource("Apple", 9 + 4 * 32, Color.get(-1, 100, 300, 500), 5, 0);
	...
	public static Resource arrow = new Resource("Arrow",  3 + 12 * 32, Color.get(-1, 200, 531, 430));
